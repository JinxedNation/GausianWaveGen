...
class InputManager
{
    public:
        ...
        void keyCallbackWrapper(GLFWwindow* m_GameWindow, int enteredKey, int scancode, int tempAction, int tempMods);
        ...
        void keyCallback(GLFWwindow* m_GameWindow, int enteredKey);
